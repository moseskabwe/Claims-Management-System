	       ...
	       <div class="claims-table-container">
				...
				<tbody>				
					<c:forEach var="payment" items="${claimPayments}">	
						...
						<tr>
							<td><p>${payment.paymentNumber}</p></td>
							<td><p><a href="${showClaimDetails}">${payment.claim.claimNumber}</a></p></td>
							<td><p><a href="${selectPolicyholder}">${payment.claim.policyHolder.policyHolderNumber}</a></p></td>
