					...
					<table style="margin-bottom:0px;">
						...
						<tbody>
							<c:forEach var="policy" items="${policyList}">
								...
								<tr>
									<td><p>${policy.policyNumber}</p></td>
									<td><p>${policy.policyType}</p></td>
									<td><p>${policy.property.propertyAddress}</p></td>
									<td><p>${policy.inceptionDate}</p></td>
									<td><p><a href="${selectPolicy}">Select</a></p></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
