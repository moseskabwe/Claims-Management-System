					...
					<thead>
			     	...
			     	<tbody>
						<c:forEach var="policyholder" items="${policyholderList}">	
							...
							<tr>
								<td><p>${policyholder.policyHolderNumber}</p></td>
								<td><p>${policyholder.firstName}</p></td>
								<td><p>${policyholder.lastName}</p></td>
								<td><p>${policyholder.email}</p></td>
								<td><p>${policyholder.phoneNumber}</p></td>
								<td><p><a href="${selectPolicyholder}">Select</a></p></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
